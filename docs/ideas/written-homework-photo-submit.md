...
| Upload в свободной практике | ~~Противоречит цели «только сравнить»~~ — **снято:** опциональные фото (до 3) разрешены; см. [`student-multi-photo-answer-paste.md`](../specs/student-multi-photo-answer-paste.md) |
| Несколько фото на шаг | ~~Вне MVP~~ — **снято:** до 3 фото (`answer_image_ids[]`); см. multi-photo spec |
