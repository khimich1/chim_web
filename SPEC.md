...
**Статус:** частично согласован (§1.6 AI-советчик — адаптация `RAG_chemistry`; §14 UI redesign — визуальный язык согласован по референсам; §1.3.1 — step-dots + возобновление сессии; AC-6.2 — sources только из учебника, v0.7.3)  
...
| Тесты (Stepik) | Одно задание на экран; **StepProgressDots** сверху (горизонтальный скролл при 28 шагах); кнопки «Проверить/Подсказка/Разбор» — крупные, sticky |
