...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-seo-specialist.md»
...
4. **SEO Skill**: Load `.cursor/.cursor/skills/mkt-mkt-seo-mastery/SKILL.md`
...
skill `mkt-workflow-content-blog` "topic" "target-keyword"
# Review with SEO Specialist

# For optimization
skill `mkt-workflow-seo-optimize` "content-file" "keyword"
# Uses SEO Specialist for recommendations

# For keyword research
skill `mkt-workflow-seo-keywords` "topic"
...
| Find content | `Glob` | Search `docs/marketing/content/*.md` |
