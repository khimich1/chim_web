...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-upsell-maximizer.md»
...
4. **Pricing Skill**: Load `.cursor/.cursor/skills/mkt-mkt-pricing-strategy/SKILL.md`
5. **Email Skill**: Load `.cursor/.cursor/skills/mkt-mkt-email-marketing/SKILL.md`
6. **Paywall Skill**: Load `.cursor/.cursor/skills/mkt-mkt-paywall-upgrade-cro/SKILL.md`
...
| Find templates | `Glob` | Search `docs/marketing/content/emails/` |
