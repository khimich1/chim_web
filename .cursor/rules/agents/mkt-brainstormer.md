...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-brainstormer.md»
...
2. **Brand Guidelines**: Read `docs/marketing/brand-context.md` for positioning constraints
3. **Marketing Ideas**: Load `.cursor/.cursor/skills/mkt-mkt-marketing-ideas/SKILL.md` for 140+ tactics
4. **Psychology**: Load `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md` for mental models
