...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-planner.md»
...
4. **Skill Reference**: Load `.cursor/.cursor/skills/mkt-mkt-content-strategy/SKILL.md` for planning frameworks
