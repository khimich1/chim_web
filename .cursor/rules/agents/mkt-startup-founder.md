...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-startup-founder.md»
...
4. **Growth Skill**: Load `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md`
5. **Launch Skill**: Load `.cursor/.cursor/skills/mkt-mkt-launch-strategy/SKILL.md`
