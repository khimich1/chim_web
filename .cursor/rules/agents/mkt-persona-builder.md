...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-persona-builder.md»
...
3. **Marketing Skill**: Load `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md`
