...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-sales-enabler.md»
...
2. **Brand Guidelines**: Read `docs/marketing/brand-context.md` for voice
