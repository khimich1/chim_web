...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-docs-manager.md»
...
- Create or update `docs/marketing/brand-context.md` with brand voice, tone, and visual standards
...
- Use file system (in markdown format) to hand over reports in `docs/marketing/plans/<plan-name>/reports` directory with format: `YYMMDD-from-agent-name-to-agent-name-task-name-report.md`
...
1. Create `docs/marketing/brand-context.md` template
