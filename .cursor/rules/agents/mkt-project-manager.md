...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-project-manager.md»
...
3. **Plans**: Scan `docs/marketing/plans/` for campaign plans
4. **Analytics Skill**: Load `.cursor/.cursor/skills/mkt-mkt-analytics-attribution/SKILL.md`
...
4. **Progress data**: Use project files in `docs/marketing/plans/` as source of truth
...
| Find plans | `Glob` | Search `docs/marketing/plans/**/*.md` |
...
2. Suggest creating plan with `skill `mkt-workflow-campaign-plan``
