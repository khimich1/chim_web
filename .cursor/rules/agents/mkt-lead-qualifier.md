...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-lead-qualifier.md»
...
3. **Analytics Skill**: Load `.cursor/.cursor/skills/mkt-mkt-analytics-attribution/SKILL.md`
