...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-email-wizard.md»
...
3. **Email Skill**: Load `.cursor/.cursor/skills/mkt-mkt-email-marketing/SKILL.md` for best practices
4. **Sequence Skill**: Load `.cursor/.cursor/skills/mkt-mkt-email-sequence/SKILL.md` for automation
5. **Subject Lines**: Check `.claude/skills/common/templates/email-subject-lines.md`
6. **Existing Emails**: Check `docs/marketing/content/` or `./docs/` for prior email work
