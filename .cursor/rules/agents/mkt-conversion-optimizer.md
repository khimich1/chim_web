...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-conversion-optimizer.md»
...
2. **Brand**: Read `docs/marketing/brand-context.md` for voice constraints
...
# For email campaigns
skill `mkt-workflow-content-email` "welcome" "trial users"
# Optimize with Conversion Optimizer

# For ad copy
skill `mkt-workflow-content-ads` "platform" "objective"
