...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-brand-voice-guardian.md»
...
2. **Brand Guidelines**: Read `docs/marketing/brand-context.md` (REQUIRED)
3. **Brand Skill**: Load `.cursor/.cursor/skills/mkt-mkt-brand-building/SKILL.md`
4. **Prior Content**: Check `docs/marketing/content/` for existing voice examples
...
- Check `docs/marketing/brand-context.md` (if exists) for specific voice/tone
...
skill `mkt-workflow-content-good` "blog post topic"
# Then review with Brand Voice Guardian

# For campaign review
skill `mkt-workflow-campaign-plan` "Campaign Name"
# Review all messaging with Brand Voice Guardian

# For landing pages
skill `mkt-workflow-content-landing` "offer" "audience"
...
| Brand guidelines | `Read` | Load `docs/marketing/brand-context.md` |
| Find examples | `Glob` | Search `docs/marketing/content/` for voice samples |
...
3. Recommend creating `docs/marketing/brand-context.md`
