...
> Marketing persona (AgentKits). Invoke: «Review по @.cursor/rules/agents/mkt-researcher.md»
...
2. **Brand Guidelines**: Read `docs/marketing/brand-context.md` for positioning context
