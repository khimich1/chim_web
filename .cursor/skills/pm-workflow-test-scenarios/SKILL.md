...
description: "Generate comprehensive test scenarios from user stories or feature specs — happy paths, edge cases, and error handling. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /test-scenarios or a full test-scenarios workflow."
disable-model-invocation: true
---

# PM Workflow: test-scenarios

> Cursor adaptation of Claude Code `/test-scenarios`. Invoke explicitly:
> «Следуй skill pm-workflow-test-scenarios» или `@.cursor/skills/pm-workflow-test-scenarios/SKILL.md`

## Cursor notes

- Slash commands (`/test-scenarios`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/test-scenarios/SKILL.md`:
