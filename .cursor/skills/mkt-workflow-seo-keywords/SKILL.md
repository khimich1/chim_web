---
name: mkt-workflow-seo-keywords
description: "Conduct keyword research for topic/niche. Marketing workflow for Cursor (AgentKits). Use when the user asks for /seo:keywords or a full seo keywords workflow."
disable-model-invocation: true
---

# Marketing Workflow: seo/keywords

> Cursor adaptation of AgentKits `/seo:keywords`. Invoke explicitly:
> «Следуй skill mkt-workflow-seo-keywords» или `@.cursor/skills/mkt-workflow-seo-keywords/SKILL.md`

## Cursor notes

- Slash commands (`/seo:keywords`) недоступны — используй этот workflow skill.
...
- `mkt-workflow-seo-optimize` - Optimize content for keywords
- `mkt-workflow-content-blog` - Create keyword-targeted content
- `mkt-workflow-seo-programmatic` - Build pages at scale
