---
name: mkt-workflow-crm-lifecycle
description: "Manage contact lifecycle stage transitions. Marketing workflow for Cursor (AgentKits). Use when the user asks for /crm:lifecycle or a full crm lifecycle workflow."
disable-model-invocation: true
---

# Marketing Workflow: crm/lifecycle

> Cursor adaptation of AgentKits `/crm:lifecycle`. Invoke explicitly:
> «Следуй skill mkt-workflow-crm-lifecycle» или `@.cursor/skills/mkt-workflow-crm-lifecycle/SKILL.md`

## Cursor notes

- Slash commands (`/crm:lifecycle`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md` - Lifecycle frameworks
...
- `mkt-workflow-crm-sequence` - Create automation sequence
- `mkt-workflow-crm-score` - Update lead score
- `mkt-workflow-leads-nurture` - Design nurture campaign
