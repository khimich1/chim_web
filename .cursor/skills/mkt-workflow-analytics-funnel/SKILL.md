---
name: mkt-workflow-analytics-funnel
description: "Analyze conversion funnel performance. Marketing workflow for Cursor (AgentKits). Use when the user asks for /analytics:funnel or a full analytics funnel workflow."
disable-model-invocation: true
---

# Marketing Workflow: analytics/funnel

> Cursor adaptation of AgentKits `/analytics:funnel`. Invoke explicitly:
> «Следуй skill mkt-workflow-analytics-funnel» или `@.cursor/skills/mkt-workflow-analytics-funnel/SKILL.md`

## Cursor notes

- Slash commands (`/analytics:funnel`) недоступны — используй этот workflow skill.
...
- `mkt-workflow-cro-page` - Optimize high drop-off pages
- `mkt-workflow-cro-form` - Optimize form conversion
- `mkt-workflow-test-ab-setup` - Plan A/B tests for improvements
