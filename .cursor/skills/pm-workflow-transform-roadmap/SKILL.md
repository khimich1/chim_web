...
description: "Convert a feature-based roadmap into an outcome-focused roadmap that communicates strategic intent. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /transform-roadmap or a full transform-roadmap workflow."
disable-model-invocation: true
---

# PM Workflow: transform-roadmap

> Cursor adaptation of Claude Code `/transform-roadmap`. Invoke explicitly:
> «Следуй skill pm-workflow-transform-roadmap» или `@.cursor/skills/pm-workflow-transform-roadmap/SKILL.md`

## Cursor notes

- Slash commands (`/transform-roadmap`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/outcome-roadmap/SKILL.md`:
