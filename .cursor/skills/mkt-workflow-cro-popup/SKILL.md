---
name: mkt-workflow-cro-popup
description: "Create or optimize popups, modals, overlays for conversion. Marketing workflow for Cursor (AgentKits). Use when the user asks for /cro:popup or a full cro popup workflow."
disable-model-invocation: true
---

# Marketing Workflow: cro/popup

> Cursor adaptation of AgentKits `/cro:popup`. Invoke explicitly:
> «Следуй skill mkt-workflow-cro-popup» или `@.cursor/skills/mkt-workflow-cro-popup/SKILL.md`

## Cursor notes

- Slash commands (`/cro:popup`) недоступны — используй этот workflow skill.
...
3. **Popup Skill**: Load `.cursor/.cursor/skills/mkt-mkt-popup-cro/SKILL.md`
4. **Popup Guide**: Load `.claude/skills/popup-cro/references/popup-best-practices.md`
5. **Psychology**: Load `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md`
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-popup-cro/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-copywriting/SKILL.md`.
