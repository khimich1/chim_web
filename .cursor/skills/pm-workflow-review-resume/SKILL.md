...
description: "Comprehensive PM resume review against 10 best practices — structure, impact metrics, keywords, and actionable feedback. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /review-resume or a full review-resume workflow."
disable-model-invocation: true
---

# PM Workflow: review-resume

> Cursor adaptation of Claude Code `/review-resume`. Invoke explicitly:
> «Следуй skill pm-workflow-review-resume» или `@.cursor/skills/pm-workflow-review-resume/SKILL.md`

## Cursor notes

- Slash commands (`/review-resume`) недоступны — используй этот workflow skill.
