---
name: mkt-workflow-cro-page
description: "Optimize marketing page for conversions (homepage, landing, pricing, feature pages). Marketing workflow for Cursor (AgentKits). Use when the user asks for /cro:page or a full cro page workflow."
disable-model-invocation: true
---

# Marketing Workflow: cro/page

> Cursor adaptation of AgentKits `/cro:page`. Invoke explicitly:
> «Следуй skill mkt-workflow-cro-page» или `@.cursor/skills/mkt-workflow-cro-page/SKILL.md`

## Cursor notes

- Slash commands (`/cro:page`) недоступны — используй этот workflow skill.
...
2. **Brand**: Read `docs/marketing/brand-context.md` for voice guidelines
3. **CRO Skill**: Load `.cursor/.cursor/skills/mkt-mkt-page-cro/SKILL.md`
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-page-cro/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-copywriting/SKILL.md`.
...
2. **Test Plan**: Run `mkt-workflow-test-ab-setup` for high-impact changes
...
6. **Iterate**: Re-run `mkt-workflow-cro-page` after changes to assess impact
