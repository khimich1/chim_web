...
description: "Comprehensive macro environment analysis — SWOT, PESTLE, Porter's Five Forces, and Ansoff Matrix in one scan. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /market-scan or a full market-scan workflow."
disable-model-invocation: true
---

# PM Workflow: market-scan

> Cursor adaptation of Claude Code `/market-scan`. Invoke explicitly:
> «Следуй skill pm-workflow-market-scan» или `@.cursor/skills/pm-workflow-market-scan/SKILL.md`

## Cursor notes

- Slash commands (`/market-scan`) недоступны — используй этот workflow skill.
...
**SWOT Analysis** (Read and follow `.cursor/skills/swot-analysis/SKILL.md`):
- Internal: Strengths and Weaknesses
- External: Opportunities and Threats
- Actionable recommendations for each quadrant

**PESTLE Analysis** (Read and follow `.cursor/skills/pestle-analysis/SKILL.md`):
- Political, Economic, Social, Technological, Legal, Environmental factors
- Impact assessment and timeline for each factor

**Porter's Five Forces** (Read and follow `.cursor/skills/porters-five-forces/SKILL.md`):
...
**Ansoff Matrix** (Read and follow `.cursor/skills/ansoff-matrix/SKILL.md`):
