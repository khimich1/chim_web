...
description: "Comprehensive user research — build personas, segment users, and map the customer journey from research data. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /research-users or a full research-users workflow."
disable-model-invocation: true
---

# PM Workflow: research-users

> Cursor adaptation of Claude Code `/research-users`. Invoke explicitly:
> «Следуй skill pm-workflow-research-users» или `@.cursor/skills/pm-workflow-research-users/SKILL.md`

## Cursor notes

- Slash commands (`/research-users`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/user-personas/SKILL.md`:
...
Apply the **user-segmentation** and skill `market-segments` (see `.cursor/skills/market-segments/SKILL.md`)s:
...
Read and follow `.cursor/skills/customer-journey-map/SKILL.md`:
