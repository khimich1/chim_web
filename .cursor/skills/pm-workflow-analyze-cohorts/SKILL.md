...
description: "Perform cohort analysis on user data — retention curves, feature adoption, and engagement trends. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /analyze-cohorts or a full analyze-cohorts workflow."
disable-model-invocation: true
---

# PM Workflow: analyze-cohorts

> Cursor adaptation of Claude Code `/analyze-cohorts`. Invoke explicitly:
> «Следуй skill pm-workflow-analyze-cohorts» или `@.cursor/skills/pm-workflow-analyze-cohorts/SKILL.md`

## Cursor notes

- Slash commands (`/analyze-cohorts`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/cohort-analysis/SKILL.md`:
