---
name: mkt-workflow-growth-launch
description: "Plan product launch, feature announcement, or release strategy. Marketing workflow for Cursor (AgentKits). Use when the user asks for /growth:launch or a full growth launch workflow."
disable-model-invocation: true
---

# Marketing Workflow: growth/launch

> Cursor adaptation of AgentKits `/growth:launch`. Invoke explicitly:
> «Следуй skill mkt-workflow-growth-launch» или `@.cursor/skills/mkt-workflow-growth-launch/SKILL.md`

## Cursor notes

- Slash commands (`/growth:launch`) недоступны — используй этот workflow skill.
...
2. `docs/marketing/brand-context.md` - Brand voice for launch messaging
3. `.cursor/.cursor/skills/mkt-mkt-launch-strategy/SKILL.md` - Launch frameworks
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-launch-strategy/SKILL.md` and `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md`.
...
- `mkt-workflow-content-landing` - Create launch landing page
- `mkt-workflow-sequence-welcome` - Create onboarding emails
- `mkt-workflow-social-viral` - Plan social launch content
