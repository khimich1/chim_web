---
name: mkt-workflow-analytics-report
description: "Generate marketing performance report. Marketing workflow for Cursor (AgentKits). Use when the user asks for /analytics:report or a full analytics report workflow."
disable-model-invocation: true
---

# Marketing Workflow: analytics/report

> Cursor adaptation of AgentKits `/analytics:report`. Invoke explicitly:
> «Следуй skill mkt-workflow-analytics-report» или `@.cursor/skills/mkt-workflow-analytics-report/SKILL.md`

## Cursor notes

- Slash commands (`/analytics:report`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-analytics-attribution/SKILL.md` - Metrics definitions
...
- `mkt-workflow-analytics-roi` - Deep ROI analysis
- `mkt-workflow-analytics-funnel` - Funnel performance review
- `mkt-workflow-ops-weekly` - Include in weekly review
