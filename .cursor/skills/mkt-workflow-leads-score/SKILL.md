---
name: mkt-workflow-leads-score
description: "Design lead scoring model. Marketing workflow for Cursor (AgentKits). Use when the user asks for /leads:score or a full leads score workflow."
disable-model-invocation: true
---

# Marketing Workflow: leads/score

> Cursor adaptation of AgentKits `/leads:score`. Invoke explicitly:
> «Следуй skill mkt-workflow-leads-score» или `@.cursor/skills/mkt-workflow-leads-score/SKILL.md`

## Cursor notes

- Slash commands (`/leads:score`) недоступны — используй этот workflow skill.
...
- `mkt-workflow-leads-qualify` - Create qualification framework
- `mkt-workflow-crm-score` - Calculate individual scores
- `mkt-workflow-leads-nurture` - Design nurture by score tier
