...
description: "Tailor a PM resume to a specific job description — keyword alignment, experience reframing, and strategic optimization. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /tailor-resume or a full tailor-resume workflow."
disable-model-invocation: true
---

# PM Workflow: tailor-resume

> Cursor adaptation of Claude Code `/tailor-resume`. Invoke explicitly:
> «Следуй skill pm-workflow-tailor-resume» или `@.cursor/skills/pm-workflow-tailor-resume/SKILL.md`

## Cursor notes

- Slash commands (`/tailor-resume`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/review-resume/SKILL.md`:
