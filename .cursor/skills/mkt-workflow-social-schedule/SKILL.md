---
name: mkt-workflow-social-schedule
description: "Create social media posting schedule. Marketing workflow for Cursor (AgentKits). Use when the user asks for /social:schedule or a full social schedule workflow."
disable-model-invocation: true
---

# Marketing Workflow: social/schedule

> Cursor adaptation of AgentKits `/social:schedule`. Invoke explicitly:
> «Следуй skill mkt-workflow-social-schedule» или `@.cursor/skills/mkt-workflow-social-schedule/SKILL.md`

## Cursor notes

- Slash commands (`/social:schedule`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-social-media/SKILL.md` - Platform guidelines
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-social-media/SKILL.md` and `.cursor/.cursor/skills/mkt-mkt-content-strategy/SKILL.md`.
...
- `mkt-workflow-content-social` - Create social content
