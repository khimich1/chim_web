---
name: mkt-workflow-seo-optimize
description: "Optimize content for target keywords. Marketing workflow for Cursor (AgentKits). Use when the user asks for /seo:optimize or a full seo optimize workflow."
disable-model-invocation: true
---

# Marketing Workflow: seo/optimize

> Cursor adaptation of AgentKits `/seo:optimize`. Invoke explicitly:
> «Следуй skill mkt-workflow-seo-optimize» или `@.cursor/skills/mkt-workflow-seo-optimize/SKILL.md`

## Cursor notes

- Slash commands (`/seo:optimize`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-seo-mastery/SKILL.md` - On-page SEO
...
- `mkt-workflow-seo-schema` - Add schema markup
- `mkt-workflow-seo-audit` - Full site audit
- `mkt-workflow-content-cro` - Optimize for conversions
