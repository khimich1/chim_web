---
name: mkt-workflow-audit-full
description: "Comprehensive marketing audit across all channels. Marketing workflow for Cursor (AgentKits). Use when the user asks for /audit:full or a full audit full workflow."
disable-model-invocation: true
---

# Marketing Workflow: audit/full

> Cursor adaptation of AgentKits `/audit:full`. Invoke explicitly:
> «Следуй skill mkt-workflow-audit-full» или `@.cursor/skills/mkt-workflow-audit-full/SKILL.md`

## Cursor notes

- Slash commands (`/audit:full`) недоступны — используй этот workflow skill.
...
2. `docs/marketing/brand-context.md` - Brand standards
3. `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md` - Marketing frameworks
4. `.cursor/.cursor/skills/mkt-mkt-seo-mastery/SKILL.md` - SEO checklist
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-seo-mastery/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-analytics-attribution/SKILL.md`.
...
- `mkt-workflow-seo-audit` - Deep SEO-specific audit
- `mkt-workflow-cro-page` - Optimize high-priority pages
- `mkt-workflow-campaign-plan` - Plan improvement campaigns
