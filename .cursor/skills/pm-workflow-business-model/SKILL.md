...
description: "Explore business models using Lean Canvas, Business Model Canvas, Startup Canvas, or Value Proposition frameworks. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /business-model or a full business-model workflow."
disable-model-invocation: true
---

# PM Workflow: business-model

> Cursor adaptation of Claude Code `/business-model`. Invoke explicitly:
> «Следуй skill pm-workflow-business-model» или `@.cursor/skills/pm-workflow-business-model/SKILL.md`

## Cursor notes

- Slash commands (`/business-model`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/lean-canvas/SKILL.md` to produce a complete Lean Canvas:
...
Read and follow `.cursor/skills/business-model/SKILL.md` to produce all 9 building blocks:
...
Read and follow `.cursor/skills/startup-canvas/SKILL.md` to produce a Startup Canvas with 9 strategy sections + business model:
...
Read and follow `.cursor/skills/value-proposition/SKILL.md` to produce a JTBD-framed value proposition:
