...
description: "Create a sales-ready competitive battlecard — positioning, feature comparison, objection handling, and win strategies. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /battlecard or a full battlecard workflow."
disable-model-invocation: true
---

# PM Workflow: battlecard

> Cursor adaptation of Claude Code `/battlecard`. Invoke explicitly:
> «Следуй skill pm-workflow-battlecard» или `@.cursor/skills/pm-workflow-battlecard/SKILL.md`

## Cursor notes

- Slash commands (`/battlecard`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/competitive-battlecard/SKILL.md` with web research:
