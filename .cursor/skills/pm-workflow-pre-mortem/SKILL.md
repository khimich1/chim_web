...
description: "Run a pre-mortem risk analysis on a PRD, launch plan, or feature — identify what could go wrong before it does. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /pre-mortem or a full pre-mortem workflow."
disable-model-invocation: true
---

# PM Workflow: pre-mortem

> Cursor adaptation of Claude Code `/pre-mortem`. Invoke explicitly:
> «Следуй skill pm-workflow-pre-mortem» или `@.cursor/skills/pm-workflow-pre-mortem/SKILL.md`

## Cursor notes

- Slash commands (`/pre-mortem`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/pre-mortem/SKILL.md`:
