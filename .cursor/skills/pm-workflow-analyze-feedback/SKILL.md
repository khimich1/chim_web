...
description: "Analyze user feedback at scale — sentiment analysis, theme extraction, and segment-level insights. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /analyze-feedback or a full analyze-feedback workflow."
disable-model-invocation: true
---

# PM Workflow: analyze-feedback

> Cursor adaptation of Claude Code `/analyze-feedback`. Invoke explicitly:
> «Следуй skill pm-workflow-analyze-feedback» или `@.cursor/skills/pm-workflow-analyze-feedback/SKILL.md`

## Cursor notes

- Slash commands (`/analyze-feedback`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/sentiment-analysis/SKILL.md`:
