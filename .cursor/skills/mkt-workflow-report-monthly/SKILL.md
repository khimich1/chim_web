---
name: mkt-workflow-report-monthly
description: "Generate client-ready monthly marketing report. Marketing workflow for Cursor (AgentKits). Use when the user asks for /report:monthly or a full report monthly workflow."
disable-model-invocation: true
---

# Marketing Workflow: report/monthly

> Cursor adaptation of AgentKits `/report:monthly`. Invoke explicitly:
> «Следуй skill mkt-workflow-report-monthly» или `@.cursor/skills/mkt-workflow-report-monthly/SKILL.md`

## Cursor notes

- Slash commands (`/report:monthly`) недоступны — используй этот workflow skill.
...
- `mkt-workflow-ops-monthly` - Internal monthly review
- `mkt-workflow-campaign-plan` - Plan next month campaigns
