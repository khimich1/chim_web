---
name: mkt-workflow-checklist-analytics-monthly
description: "Monthly analytics review and insights template. Marketing workflow for Cursor (AgentKits). Use when the user asks for /checklist:analytics-monthly or a full checklist analytics-monthly workflow."
disable-model-invocation: true
---

# Marketing Workflow: checklist/analytics-monthly

> Cursor adaptation of AgentKits `/checklist:analytics-monthly`. Invoke explicitly:
> «Следуй skill mkt-workflow-checklist-analytics-monthly» или `@.cursor/skills/mkt-workflow-checklist-analytics-monthly/SKILL.md`

## Cursor notes

- Slash commands (`/checklist:analytics-monthly`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-analytics-attribution/SKILL.md` - Analytics frameworks
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-analytics-attribution/SKILL.md` and `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md`.
...
- `mkt-workflow-report-monthly` - Generate client report
- `mkt-workflow-ops-monthly` - Monthly operations review
- `mkt-workflow-analytics-funnel` - Deep funnel analysis
