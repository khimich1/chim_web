...
description: "Design sustainable growth mechanisms — growth loops and GTM motions for product-led and sales-led strategies. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /growth-strategy or a full growth-strategy workflow."
disable-model-invocation: true
---

# PM Workflow: growth-strategy

> Cursor adaptation of Claude Code `/growth-strategy`. Invoke explicitly:
> «Следуй skill pm-workflow-growth-strategy» или `@.cursor/skills/pm-workflow-growth-strategy/SKILL.md`

## Cursor notes

- Slash commands (`/growth-strategy`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/growth-loops/SKILL.md`:
...
Read and follow `.cursor/skills/gtm-motions/SKILL.md`:
