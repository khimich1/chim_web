---
name: mkt-workflow-campaign-analyze
description: "Analyze campaign performance and provide insights. Marketing workflow for Cursor (AgentKits). Use when the user asks for /campaign:analyze or a full campaign analyze workflow."
disable-model-invocation: true
---

# Marketing Workflow: campaign/analyze

> Cursor adaptation of AgentKits `/campaign:analyze`. Invoke explicitly:
> «Следуй skill mkt-workflow-campaign-analyze» или `@.cursor/skills/mkt-workflow-campaign-analyze/SKILL.md`

## Cursor notes

- Slash commands (`/campaign:analyze`) недоступны — используй этот workflow skill.
