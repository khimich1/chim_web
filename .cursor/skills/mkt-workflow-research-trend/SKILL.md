---
name: mkt-workflow-research-trend
description: "Analyze industry/market trends. Marketing workflow for Cursor (AgentKits). Use when the user asks for /research:trend or a full research trend workflow."
disable-model-invocation: true
---

# Marketing Workflow: research/trend

> Cursor adaptation of AgentKits `/research:trend`. Invoke explicitly:
> «Следуй skill mkt-workflow-research-trend» или `@.cursor/skills/mkt-workflow-research-trend/SKILL.md`

## Cursor notes

- Slash commands (`/research:trend`) недоступны — используй этот workflow skill.
...
2. `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md` - Trend frameworks
...
- `mkt-workflow-research-market` - Full market analysis
- `mkt-workflow-content-blog` - Create trend-focused content
- `mkt-workflow-campaign-plan` - Plan trend-aligned campaigns
