...
description: "Prepare a customer interview script or summarize an interview transcript into structured insights. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /interview or a full interview workflow."
disable-model-invocation: true
---

# PM Workflow: interview

> Cursor adaptation of Claude Code `/interview`. Invoke explicitly:
> «Следуй skill pm-workflow-interview» или `@.cursor/skills/pm-workflow-interview/SKILL.md`

## Cursor notes

- Slash commands (`/interview`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/interview-script/SKILL.md`:
...
Read and follow `.cursor/skills/summarize-interview/SKILL.md`:
