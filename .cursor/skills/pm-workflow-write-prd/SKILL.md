...
description: "Create a comprehensive Product Requirements Document from a feature idea or problem statement. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /write-prd or a full write-prd workflow."
disable-model-invocation: true
---

# PM Workflow: write-prd

> Cursor adaptation of Claude Code `/write-prd`. Invoke explicitly:
> «Следуй skill pm-workflow-write-prd» или `@.cursor/skills/pm-workflow-write-prd/SKILL.md`

## Cursor notes

- Slash commands (`/write-prd`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/create-prd/SKILL.md` to produce an 8-section document:
