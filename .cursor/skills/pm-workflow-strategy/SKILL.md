...
description: "Create a comprehensive product strategy using the 9-section Strategy Canvas — from vision to defensibility. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /strategy or a full strategy workflow."
disable-model-invocation: true
---

# PM Workflow: strategy

> Cursor adaptation of Claude Code `/strategy`. Invoke explicitly:
> «Следуй skill pm-workflow-strategy» или `@.cursor/skills/pm-workflow-strategy/SKILL.md`

## Cursor notes

- Slash commands (`/strategy`) недоступны — используй этот workflow skill.
...
Apply the **product-strategy** and skill `product-vision` (see `.cursor/skills/product-vision/SKILL.md`)s:
