...
description: "Design a product metrics dashboard with North Star metric, input metrics, health metrics, and alert thresholds. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /setup-metrics or a full setup-metrics workflow."
disable-model-invocation: true
---

# PM Workflow: setup-metrics

> Cursor adaptation of Claude Code `/setup-metrics`. Invoke explicitly:
> «Следуй skill pm-workflow-setup-metrics» или `@.cursor/skills/pm-workflow-setup-metrics/SKILL.md`

## Cursor notes

- Slash commands (`/setup-metrics`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/metrics-dashboard/SKILL.md`:
