---
name: mkt-workflow-sequence-nurture
description: "Create lead nurturing sequence to convert leads to MQL/SQL. Marketing workflow for Cursor (AgentKits). Use when the user asks for /sequence:nurture or a full sequence nurture workflow."
disable-model-invocation: true
---

# Marketing Workflow: sequence/nurture

> Cursor adaptation of AgentKits `/sequence:nurture`. Invoke explicitly:
> «Следуй skill mkt-workflow-sequence-nurture» или `@.cursor/skills/mkt-workflow-sequence-nurture/SKILL.md`

## Cursor notes

- Slash commands (`/sequence:nurture`) недоступны — используй этот workflow skill.
...
- `mkt-workflow-sequence-welcome` - Create welcome sequence
