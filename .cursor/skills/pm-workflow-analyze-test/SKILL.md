...
description: "Analyze A/B test results — statistical significance, sample size validation, and ship/extend/stop recommendations. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /analyze-test or a full analyze-test workflow."
disable-model-invocation: true
---

# PM Workflow: analyze-test

> Cursor adaptation of Claude Code `/analyze-test`. Invoke explicitly:
> «Следуй skill pm-workflow-analyze-test» или `@.cursor/skills/pm-workflow-analyze-test/SKILL.md`

## Cursor notes

- Slash commands (`/analyze-test`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/ab-test-analysis/SKILL.md`:
