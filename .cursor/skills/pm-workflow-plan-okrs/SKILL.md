...
description: "Brainstorm team-level OKRs aligned with company objectives — qualitative objectives with measurable key results. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /plan-okrs or a full plan-okrs workflow."
disable-model-invocation: true
---

# PM Workflow: plan-okrs

> Cursor adaptation of Claude Code `/plan-okrs`. Invoke explicitly:
> «Следуй skill pm-workflow-plan-okrs» или `@.cursor/skills/pm-workflow-plan-okrs/SKILL.md`

## Cursor notes

- Slash commands (`/plan-okrs`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/brainstorm-okrs/SKILL.md`:
