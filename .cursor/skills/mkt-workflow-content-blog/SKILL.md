---
name: mkt-workflow-content-blog
description: "Create SEO-optimized blog post. Marketing workflow for Cursor (AgentKits). Use when the user asks for /content:blog or a full content blog workflow."
disable-model-invocation: true
---

# Marketing Workflow: content/blog

> Cursor adaptation of AgentKits `/content:blog`. Invoke explicitly:
> «Следуй skill mkt-workflow-content-blog» или `@.cursor/skills/mkt-workflow-content-blog/SKILL.md`

## Cursor notes

- Slash commands (`/content:blog`) недоступны — используй этот workflow skill.
...
- [ ] Brand guidelines available in `docs/marketing/brand-context.md`
...
2. **Brand**: Read `docs/marketing/brand-context.md` for voice and tone
3. **SEO Skill**: Load `.cursor/.cursor/skills/mkt-mkt-seo-mastery/SKILL.md`
4. **Content Skill**: Load `.cursor/.cursor/skills/mkt-mkt-content-strategy/SKILL.md`
5. **Copywriting**: Load `.cursor/.cursor/skills/mkt-mkt-copywriting/SKILL.md`
6. **Existing Content**: Check `docs/marketing/content/blog/` for related posts (internal linking)
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-seo-mastery/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-content-strategy/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-copywriting/SKILL.md`.
...
Save post to: `docs/marketing/content/blog/[slug].md`
...
- [ ] **Brand Voice**: Matches guidelines in `docs/marketing/brand-context.md`
...
2. **SEO Check**: Run `mkt-workflow-seo-optimize` for final SEO review
3. **Publish**: Add to CMS with meta tags
4. **Promote**: Run `mkt-workflow-social-schedule` for distribution
