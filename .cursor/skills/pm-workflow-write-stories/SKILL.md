...
description: "Break a feature into backlog items — user stories, job stories, or WWA format with acceptance criteria. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /write-stories or a full write-stories workflow."
disable-model-invocation: true
---

# PM Workflow: write-stories

> Cursor adaptation of Claude Code `/write-stories`. Invoke explicitly:
> «Следуй skill pm-workflow-write-stories» или `@.cursor/skills/pm-workflow-write-stories/SKILL.md`

## Cursor notes

- Slash commands (`/write-stories`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/user-stories/SKILL.md`:
...
Read and follow `.cursor/skills/job-stories/SKILL.md`:
...
Read and follow `.cursor/skills/wwas/SKILL.md`:
