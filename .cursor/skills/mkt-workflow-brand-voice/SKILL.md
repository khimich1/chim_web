---
name: mkt-workflow-brand-voice
description: "Create brand voice guidelines. Marketing workflow for Cursor (AgentKits). Use when the user asks for /brand:voice or a full brand voice workflow."
disable-model-invocation: true
---

# Marketing Workflow: brand/voice

> Cursor adaptation of AgentKits `/brand:voice`. Invoke explicitly:
> «Следуй skill mkt-workflow-brand-voice» или `@.cursor/skills/mkt-workflow-brand-voice/SKILL.md`

## Cursor notes

- Slash commands (`/brand:voice`) недоступны — используй этот workflow skill.
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-brand-building/SKILL.md` and `.cursor/.cursor/skills/mkt-mkt-copywriting/SKILL.md`.
...
- `mkt-workflow-brand-book` - Full brand book
- `mkt-workflow-content-good` - Write on-brand copy
- `mkt-workflow-content-editing` - Edit copy for brand consistency
