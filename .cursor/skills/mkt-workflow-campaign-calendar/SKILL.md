---
name: mkt-workflow-campaign-calendar
description: "Generate content calendar for campaign. Marketing workflow for Cursor (AgentKits). Use when the user asks for /campaign:calendar or a full campaign calendar workflow."
disable-model-invocation: true
---

# Marketing Workflow: campaign/calendar

> Cursor adaptation of AgentKits `/campaign:calendar`. Invoke explicitly:
> «Следуй skill mkt-workflow-campaign-calendar» или `@.cursor/skills/mkt-workflow-campaign-calendar/SKILL.md`

## Cursor notes

- Slash commands (`/campaign:calendar`) недоступны — используй этот workflow skill.
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-content-strategy/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-social-media/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md`.
