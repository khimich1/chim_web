---
name: mkt-workflow-leads-nurture
description: "Design lead nurture sequence. Marketing workflow for Cursor (AgentKits). Use when the user asks for /leads:nurture or a full leads nurture workflow."
disable-model-invocation: true
---

# Marketing Workflow: leads/nurture

> Cursor adaptation of AgentKits `/leads:nurture`. Invoke explicitly:
> «Следуй skill mkt-workflow-leads-nurture» или `@.cursor/skills/mkt-workflow-leads-nurture/SKILL.md`

## Cursor notes

- Slash commands (`/leads:nurture`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-email-sequence/SKILL.md` - Nurture frameworks
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-email-marketing/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-email-sequence/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-content-strategy/SKILL.md`.
...
- `mkt-workflow-crm-sequence` - Implement in CRM
- `mkt-workflow-content-email` - Write detailed email copy
- `mkt-workflow-leads-score` - Design scoring model
