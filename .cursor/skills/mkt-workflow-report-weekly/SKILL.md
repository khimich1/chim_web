---
name: mkt-workflow-report-weekly
description: "Generate client-ready weekly marketing report. Marketing workflow for Cursor (AgentKits). Use when the user asks for /report:weekly or a full report weekly workflow."
disable-model-invocation: true
---

# Marketing Workflow: report/weekly

> Cursor adaptation of AgentKits `/report:weekly`. Invoke explicitly:
> «Следуй skill mkt-workflow-report-weekly» или `@.cursor/skills/mkt-workflow-report-weekly/SKILL.md`

## Cursor notes

- Slash commands (`/report:weekly`) недоступны — используй этот workflow skill.
...
- `mkt-workflow-ops-weekly` - Internal weekly review
- `mkt-workflow-report-monthly` - Monthly report
- `mkt-workflow-campaign-analyze` - Campaign performance analysis
