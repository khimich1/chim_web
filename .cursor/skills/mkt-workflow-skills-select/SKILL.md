---
name: mkt-workflow-skills-select
description: "Intelligently select optimal skills for a marketing task using semantic matching. Marketing workflow for Cursor (AgentKits). Use when the user asks for /skills:select or a full skills select workflow."
disable-model-invocation: true
---

# Marketing Workflow: skills/select

> Cursor adaptation of AgentKits `/skills:select`. Invoke explicitly:
> «Следуй skill mkt-workflow-skills-select» или `@.cursor/skills/mkt-workflow-skills-select/SKILL.md`

## Cursor notes

- Slash commands (`/skills:select`) недоступны — используй этот workflow skill.
