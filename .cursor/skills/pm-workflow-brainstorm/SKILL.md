...
description: "Brainstorm product ideas or experiments from PM, Designer, and Engineer perspectives — for existing or new products. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /brainstorm or a full brainstorm workflow."
disable-model-invocation: true
---

# PM Workflow: brainstorm

> Cursor adaptation of Claude Code `/brainstorm`. Invoke explicitly:
> «Следуй skill pm-workflow-brainstorm» или `@.cursor/skills/pm-workflow-brainstorm/SKILL.md`

## Cursor notes

- Slash commands (`/brainstorm`) недоступны — используй этот workflow skill.
...
**If brainstorming ideas** — Read `.cursor/skills/brainstorm-ideas-existing/SKILL.md` or `.cursor/skills/brainstorm-ideas-new/SKILL.md`:
...
**If brainstorming experiments** — Read `.cursor/skills/brainstorm-experiments-existing/SKILL.md` or `.cursor/skills/brainstorm-experiments-new/SKILL.md`:
