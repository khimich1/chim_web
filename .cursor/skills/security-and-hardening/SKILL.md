...
These are prevention patterns, not a ranking. For the 2021 ordering, see the quick-reference table in `.cursor/rules/references/security-checklist.md`.
...
For detailed security checklists and pre-commit verification steps, see `.cursor/rules/references/security-checklist.md`.
