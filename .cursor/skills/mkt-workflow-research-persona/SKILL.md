---
name: mkt-workflow-research-persona
description: "Create detailed buyer persona. Marketing workflow for Cursor (AgentKits). Use when the user asks for /research:persona or a full research persona workflow."
disable-model-invocation: true
---

# Marketing Workflow: research/persona

> Cursor adaptation of AgentKits `/research:persona`. Invoke explicitly:
> «Следуй skill mkt-workflow-research-persona» или `@.cursor/skills/mkt-workflow-research-persona/SKILL.md`

## Cursor notes

- Slash commands (`/research:persona`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md` - Persona frameworks
...
- `mkt-workflow-content-landing` - Create persona-targeted landing page
- `mkt-workflow-sequence-nurture` - Create persona-specific nurture
- `mkt-workflow-sales-pitch` - Create persona-specific pitch
