---
name: mkt-workflow-ops-daily
description: "Daily marketing tasks checklist and review. Marketing workflow for Cursor (AgentKits). Use when the user asks for /ops:daily or a full ops daily workflow."
disable-model-invocation: true
---

# Marketing Workflow: ops/daily

> Cursor adaptation of AgentKits `/ops:daily`. Invoke explicitly:
> «Следуй skill mkt-workflow-ops-daily» или `@.cursor/skills/mkt-workflow-ops-daily/SKILL.md`

## Cursor notes

- Slash commands (`/ops:daily`) недоступны — используй этот workflow skill.
...
### MCP Sources
Use MCP for real-time data; tasks from `docs/marketing/plans/` files:
...
- `mkt-workflow-ops-weekly` - Weekly review and planning
- `mkt-workflow-leads-nurture` - Plan nurture for leads
- `mkt-workflow-content-social` - Create daily social content
