---
name: mkt-workflow-seo-audit
description: "Perform comprehensive SEO audit. Marketing workflow for Cursor (AgentKits). Use when the user asks for /seo:audit or a full seo audit workflow."
disable-model-invocation: true
---

# Marketing Workflow: seo/audit

> Cursor adaptation of AgentKits `/seo:audit`. Invoke explicitly:
> «Следуй skill mkt-workflow-seo-audit» или `@.cursor/skills/mkt-workflow-seo-audit/SKILL.md`

## Cursor notes

- Slash commands (`/seo:audit`) недоступны — используй этот workflow skill.
...
- `mkt-workflow-seo-optimize` - Optimize specific pages
- `mkt-workflow-seo-schema` - Add schema markup
- `mkt-workflow-seo-keywords` - Conduct keyword research
