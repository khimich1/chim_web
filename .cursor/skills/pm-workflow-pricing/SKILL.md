...
description: "Design a pricing strategy — models, competitive analysis, willingness-to-pay estimation, and pricing experiments. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /pricing or a full pricing workflow."
disable-model-invocation: true
---

# PM Workflow: pricing

> Cursor adaptation of Claude Code `/pricing`. Invoke explicitly:
> «Следуй skill pm-workflow-pricing» или `@.cursor/skills/pm-workflow-pricing/SKILL.md`

## Cursor notes

- Slash commands (`/pricing`) недоступны — используй этот workflow skill.
...
Apply the **pricing-strategy** and skill `monetization-strategy` (see `.cursor/skills/monetization-strategy/SKILL.md`)s:
