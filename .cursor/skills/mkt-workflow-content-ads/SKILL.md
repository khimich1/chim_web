---
name: mkt-workflow-content-ads
description: "Create ad copy for paid campaigns. Marketing workflow for Cursor (AgentKits). Use when the user asks for /content:ads or a full content ads workflow."
disable-model-invocation: true
---

# Marketing Workflow: content/ads

> Cursor adaptation of AgentKits `/content:ads`. Invoke explicitly:
> «Следуй skill mkt-workflow-content-ads» или `@.cursor/skills/mkt-workflow-content-ads/SKILL.md`

## Cursor notes

- Slash commands (`/content:ads`) недоступны — используй этот workflow skill.
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-paid-advertising/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-copywriting/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md`.
