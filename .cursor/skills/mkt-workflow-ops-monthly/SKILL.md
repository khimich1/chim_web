---
name: mkt-workflow-ops-monthly
description: "Monthly marketing performance review and strategy adjustment. Marketing workflow for Cursor (AgentKits). Use when the user asks for /ops:monthly or a full ops monthly workflow."
disable-model-invocation: true
---

# Marketing Workflow: ops/monthly

> Cursor adaptation of AgentKits `/ops:monthly`. Invoke explicitly:
> «Следуй skill mkt-workflow-ops-monthly» или `@.cursor/skills/mkt-workflow-ops-monthly/SKILL.md`

## Cursor notes

- Slash commands (`/ops:monthly`) недоступны — используй этот workflow skill.
...
- `mkt-workflow-report-monthly` - Client-ready report
- `mkt-workflow-campaign-plan` - Next month campaigns
