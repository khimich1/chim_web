---
name: mkt-workflow-content-editing
description: "Edit, review, or improve existing marketing copy. Marketing workflow for Cursor (AgentKits). Use when the user asks for /content:editing or a full content editing workflow."
disable-model-invocation: true
---

# Marketing Workflow: content/editing

> Cursor adaptation of AgentKits `/content:editing`. Invoke explicitly:
> «Следуй skill mkt-workflow-content-editing» или `@.cursor/skills/mkt-workflow-content-editing/SKILL.md`

## Cursor notes

- Slash commands (`/content:editing`) недоступны — используй этот workflow skill.
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-copy-editing/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-copywriting/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md`.
