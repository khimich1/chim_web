---
name: mkt-workflow-content-cro
description: "Analyze the current content and optimize for conversion. Marketing workflow for Cursor (AgentKits). Use when the user asks for /content:cro or a full content cro workflow."
disable-model-invocation: true
---

# Marketing Workflow: content/cro

> Cursor adaptation of AgentKits `/content:cro`. Invoke explicitly:
> «Следуй skill mkt-workflow-content-cro» или `@.cursor/skills/mkt-workflow-content-cro/SKILL.md`

## Cursor notes

- Slash commands (`/content:cro`) недоступны — используй этот workflow skill.
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md` and `.cursor/.cursor/skills/mkt-mkt-copywriting/SKILL.md`.
