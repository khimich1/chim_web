---
name: mkt-workflow-checklist-campaign-launch
description: "Pre-launch campaign checklist to ensure nothing is missed. Marketing workflow for Cursor (AgentKits). Use when the user asks for /checklist:campaign-launch or a full checklist campaign-launch workflow."
disable-model-invocation: true
---

# Marketing Workflow: checklist/campaign-launch

> Cursor adaptation of AgentKits `/checklist:campaign-launch`. Invoke explicitly:
> «Следуй skill mkt-workflow-checklist-campaign-launch» или `@.cursor/skills/mkt-workflow-checklist-campaign-launch/SKILL.md`

## Cursor notes

- Slash commands (`/checklist:campaign-launch`) недоступны — используй этот workflow skill.
...
3. `docs/marketing/plans/` - Active campaign plans
...
- `mkt-workflow-campaign-plan` - Create full campaign plan
- `mkt-workflow-campaign-brief` - Generate creative brief
- `mkt-workflow-campaign-analyze` - Post-launch analysis
