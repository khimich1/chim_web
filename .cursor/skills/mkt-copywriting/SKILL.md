...
Follow these core principles. For detailed editing checks and word-by-word polish, use the skill `mkt-copy-editing` (see `.cursor/skills/mkt-copy-editing/SKILL.md`) after your initial draft.
...
For a thorough line-by-line review, run the copy through the skill `mkt-copy-editing` (see `.cursor/skills/mkt-copy-editing/SKILL.md`)'s Seven Sweeps framework.
