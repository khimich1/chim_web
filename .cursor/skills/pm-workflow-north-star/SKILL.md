...
description: "Define your North Star Metric and supporting input metrics — classify the business game and validate against best practices. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /north-star or a full north-star workflow."
disable-model-invocation: true
---

# PM Workflow: north-star

> Cursor adaptation of Claude Code `/north-star`. Invoke explicitly:
> «Следуй skill pm-workflow-north-star» или `@.cursor/skills/pm-workflow-north-star/SKILL.md`

## Cursor notes

- Slash commands (`/north-star`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/north-star-metric/SKILL.md`:
