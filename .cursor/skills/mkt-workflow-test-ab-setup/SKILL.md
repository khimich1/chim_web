---
name: mkt-workflow-test-ab-setup
description: "Plan and design A/B test or experiment. Marketing workflow for Cursor (AgentKits). Use when the user asks for /test:ab-setup or a full test ab-setup workflow."
disable-model-invocation: true
---

# Marketing Workflow: test/ab-setup

> Cursor adaptation of AgentKits `/test:ab-setup`. Invoke explicitly:
> «Следуй skill mkt-workflow-test-ab-setup» или `@.cursor/skills/mkt-workflow-test-ab-setup/SKILL.md`

## Cursor notes

- Slash commands (`/test:ab-setup`) недоступны — используй этот workflow skill.
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-ab-test-setup/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-marketing-psychology/SKILL.md`, `.cursor/.cursor/skills/mkt-mkt-analytics-attribution/SKILL.md`.
...
- `mkt-workflow-cro-page` - Optimize test element
- `mkt-workflow-analytics-funnel` - Analyze baseline funnel
- `mkt-workflow-checklist-ab-testing` - Full testing framework
