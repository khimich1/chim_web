...
description: "Analyze, categorize, and prioritize a batch of feature requests from customers or stakeholders. End-to-end PM workflow for Cursor (chains multiple pm skills). Use when the user asks for /triage-requests or a full triage-requests workflow."
disable-model-invocation: true
---

# PM Workflow: triage-requests

> Cursor adaptation of Claude Code `/triage-requests`. Invoke explicitly:
> «Следуй skill pm-workflow-triage-requests» или `@.cursor/skills/pm-workflow-triage-requests/SKILL.md`

## Cursor notes

- Slash commands (`/triage-requests`) недоступны — используй этот workflow skill.
...
Read and follow `.cursor/skills/analyze-feature-requests/SKILL.md`:
...
Read and follow `.cursor/skills/prioritize-features/SKILL.md`:
