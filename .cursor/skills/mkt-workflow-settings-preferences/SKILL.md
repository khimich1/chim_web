---
name: mkt-workflow-settings-preferences
description: "Configure your default preferences for AgentKits Marketing. Marketing workflow for Cursor (AgentKits). Use when the user asks for /settings:preferences or a full settings preferences workflow."
disable-model-invocation: true
---

# Marketing Workflow: settings/preferences

> Cursor adaptation of AgentKits `/settings:preferences`. Invoke explicitly:
> «Следуй skill mkt-workflow-settings-preferences» или `@.cursor/skills/mkt-workflow-settings-preferences/SKILL.md`

## Cursor notes

- Slash commands (`/settings:preferences`) недоступны — используй этот workflow skill.
...
**Skills**: Read `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md`.
...
**To change:** Run `mkt-workflow-settings-preferences set`
```
...
- `mkt-workflow-campaign-plan` - Plan your first campaign
- `mkt-workflow-ops-daily` - Daily marketing tasks
