---
name: mkt-workflow-checklist-ab-testing
description: "A/B testing framework for marketing optimization. Marketing workflow for Cursor (AgentKits). Use when the user asks for /checklist:ab-testing or a full checklist ab-testing workflow."
disable-model-invocation: true
---

# Marketing Workflow: checklist/ab-testing

> Cursor adaptation of AgentKits `/checklist:ab-testing`. Invoke explicitly:
> «Следуй skill mkt-workflow-checklist-ab-testing» или `@.cursor/skills/mkt-workflow-checklist-ab-testing/SKILL.md`

## Cursor notes

- Slash commands (`/checklist:ab-testing`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-ab-test-setup/SKILL.md` - Testing frameworks
...
- `mkt-workflow-test-ab-setup` - Plan specific test
- `mkt-workflow-cro-page` - Optimize page elements
- `mkt-workflow-analytics-funnel` - Analyze conversion funnel
