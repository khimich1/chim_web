---
name: mkt-workflow-crm-score
description: "Calculate lead score with demographic and behavioral factors. Marketing workflow for Cursor (AgentKits). Use when the user asks for /crm:score or a full crm score workflow."
disable-model-invocation: true
---

# Marketing Workflow: crm/score

> Cursor adaptation of AgentKits `/crm:score`. Invoke explicitly:
> «Следуй skill mkt-workflow-crm-score» или `@.cursor/skills/mkt-workflow-crm-score/SKILL.md`

## Cursor notes

- Slash commands (`/crm:score`) недоступны — используй этот workflow skill.
...
3. `.cursor/.cursor/skills/mkt-mkt-marketing-fundamentals/SKILL.md` - Scoring frameworks
...
- `mkt-workflow-crm-lifecycle` - Update lifecycle stage
- `mkt-workflow-sales-qualify` - Qualify hot leads
- `mkt-workflow-sales-outreach` - Create outreach for qualified leads
