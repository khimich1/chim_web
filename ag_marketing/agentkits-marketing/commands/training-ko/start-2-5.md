...
경쟁 환경을 이해하는 것은 포지셔닝과 메시징에 매우 중요합니다. AgentKits의 경쟁사를 체계적으로 조사해 보겠습니다.
...
## 핵심 교육 포인트
- `/competitor:deep`은 전체 분석을 제공합니다
- `/seo:competitor`는 SEO 전략을 보여줍니다
- `/sales:battlecard`는 영업팀을 지원합니다
- 포지셔닝 매트릭스는 차별화를 보여줍니다
- 대응 플레이북은 시나리오에 대비합니다
